...
export default function Home() {
  ...
  <div className={`${code_pro.variable} flex items-center font-code_pro justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20`}>       
    <main className="ml-[5vw]">
      <h3 className="mb-[2vh] text-3xl"> built by bakuyy </h3>
      ...
      <h1 className="text-4xl  mt-[4vh] font-extrabold tracking-tight text-white sm:text-4xl md:text-6xl"> git commit -m “<span className="text-gray-400">docs</span>: <span className="text-[#39D353]">add my stats</span>”</h1>
      ...
      <div className="flex text-2xl gap-4 mt-[4vh]">
